...
export default function Layout({ children }) {
  ...
  return (
    <div className=" bg-slate-200 h-screen w-screen font-quick overflow-hidden">
      <div className=" flex flex-col justify-center pl-4 bg-lime-500 h-24 text-xl font-extrabold">
        <div className=" flex gap-2">
          <div className=" flex flex-col justify-center">
            <h1 className=" text-white text-2xl">SedangApa</h1>
          </div>
          <div>
            <svg
              className=" w-10 h-10"
      ...
      <div className=" flex w-screen">
        <div className=" bg-slate-100 w-60 flex flex-col gap-2 h-screen p-10 pt-6">
          ...
          <div className=" flex flex-col justify-center bg-slate-300 rounded-xl p-3 w-44 -translate-x-2 h-16 absolute bottom-10">
